...
public class PuntoTest {
	...
	public void sumarDosPuntosX(){
		...
		assertTrue( "La X de " + p1 + "+" + p2 + " deberia ser " + (x1+x2) + ":" + suma.getX(), equals(suma.getX(), x1+x2 ) );
	}
	...
	public void sumarDosPuntosY(){
		...
		Punto p2 = new Punto(x2,y2);
		Punto suma = p1.suma(p2);
		assertTrue( "La Y de " + p1 + "+" + p2 + " deberia ser " + (y1+y2) + ":" + suma.getX(), equals(suma.getY(), y1+y2 ) );
	}
