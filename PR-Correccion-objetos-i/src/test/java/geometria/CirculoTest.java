...
public class CirculoTest {
	...
	public void conversionACadena(){
		...
		assertTrue( "La conversion a cadena no es correcta para " + x + "," + y + "," + r + ":" + c, c.toString().matches(regex) );
	}
	...
	public void conversionACadenaTrasCambioDeRadio(){
		...
		assertTrue( "La conversion a cadena no es correcta tras cambiar radio para " + x + "," + y + "," + cambiado + ":" + c, c.toString().matches(regex) );
	}
	...
	public void conversionACadenaTrasCambioDeCentro(){
		...
		assertTrue( "La conversion a cadena no es correcta tras cambiar centro para " + x + "," + y + "," + cambiado + ":" + c, c.toString().matches(regex) );
	}
	...
	public void areaTrasCambioDeRadio(){
		...
		assertTrue( "El area tras cambiar radio radio a " + cambiado + " deberia ser " + a + ":" + aAlumno, equals(a,aAlumno) );
	}
